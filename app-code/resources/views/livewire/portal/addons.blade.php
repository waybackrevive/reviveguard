<div>
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500 mt-1">Order extra services — track progress here without email back-and-forth.</p>
    </div>
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto" aria-modal="true">
            <div class="flex min-h-full items-center justify-center p-4">
                ...
                <div class="relative bg-white rounded-[10px] shadow-xl w-full max-w-lg p-6 z-10">
                    ...
                    <p class="text-sm text-gray-500 mt-1">{{ $selectedAddon['price_label'] }} · Billed separately after team review</p>
                    ...
                    <form wire:submit.prevent="placeOrder" class="mt-5 space-y-4 text-sm">
                        ...
                        <div class="flex gap-3 pt-2">
                            <button type="submit" class="flex-1 bg-brand text-white font-semibold py-2.5 rounded-lg">Place order</button>
