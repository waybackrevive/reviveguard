...
<table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 3px rgba(0,0,0,.1);">
  ...
  <tr><td style="padding:36px 40px;">
    ...
    <p style="margin:0 0 16px;font-size:15px;color:#374151;line-height:1.6;">
      We attempted to restore <strong>{{ $siteUrl }}</strong> from backup but need to finish manually.
    </p>
    ...
    <p style="margin:0 0 24px;font-size:14px;color:#6b7280;line-height:1.6;">
      Our team has been alerted and will contact you shortly. You can also open a support ticket from your portal.
    </p>
    <a href="{{ $dashboardUrl }}" style="display:inline-block;background:#1d4ed8;color:#fff;text-decoration:none;font-size:14px;font-weight:600;padding:12px 24px;border-radius:8px;">Contact support →</a>
  </td></tr>
