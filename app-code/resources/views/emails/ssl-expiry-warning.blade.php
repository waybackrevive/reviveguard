...
<table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 3px rgba(0,0,0,.1);">
  ...
  <tr><td style="padding:36px 40px;">
    ...
    <p style="margin:0 0 16px;font-size:15px;color:#374151;line-height:1.6;">
      Your SSL certificate for <strong>{{ $siteUrl }}</strong> expires on
      <strong>{{ $expiresOn }}</strong> — that's <strong>{{ $daysLeft }} days from now</strong>.
    </p>

    <p style="margin:0 0 24px;font-size:15px;color:#374151;line-height:1.6;">
      An expired SSL certificate causes browsers to show a security warning to your visitors,
      which can cause people to immediately leave your site.
    </p>

    <p style="margin:0 0 24px;font-size:15px;color:#374151;line-height:1.6;">
      We're handling the renewal for you as part of your maintenance plan.
      No action is needed on your end. We'll confirm once it's renewed.
    </p>
