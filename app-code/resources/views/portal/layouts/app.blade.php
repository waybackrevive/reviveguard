...
<div class="min-h-full flex flex-col lg:flex-row relative">
    ...
    <aside id="portalSidebar" class="hidden lg:flex lg:flex-col lg:w-60 lg:fixed lg:inset-y-0 bg-white border-r border-gray-200 transition-transform duration-200">
